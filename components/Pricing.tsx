      ...
      <div className="container-lg">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="bg-blue-600 px-8 py-5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-white">{t("pricing-package-name")}</span>
              </div>
            ...
            <div className="px-8 py-10">
              ...
              <div className="text-center mb-10">
                <div className="flex items-end justify-center gap-1 mb-1">
                  <span className="text-6xl font-bold text-slate-900 tracking-tight">600</span>
                  <span className="text-2xl font-semibold text-slate-400 mb-2">
                    {t("pricing-currency")}
                  </span>
                </div>
                <p className="text-slate-500 text-[15px]">{t("pricing-payment-term")}</p>
              </div>
              ...
              <ul className="grid md:grid-cols-2 gap-3 mb-10">
                {features.map((feat, i) => (
                  <li key={i} className="flex items-start gap-2.5">
                    ...
                    <span className="text-[14px] text-slate-700 font-medium leading-snug">{feat}</span>
                  </li>
                ))}
              </ul>
          ...
          <p className="mt-6 text-center text-slate-500 text-[14px]">
            ...
            <Link href="#contact" className="text-blue-600 hover:text-blue-700 font-semibold underline underline-offset-2 transition-colors">
